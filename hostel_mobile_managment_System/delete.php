...
else
{
    if($_POST) {
       ...
       // $year12=$_POST['year12'];
        if($post1) {
            $sql2="DELETE from info where rollno='$post1'";
            $result2=mysqli_query($conn, $sql2);
         //   $sql1="DELETE FROM info WHERE year='$year12'";
           // $result1=mysqli_query($conn, $sql1);
            if( $result2== true) {
                $sql3="DELETE from login where uname='$post1' and status='student'";
                $result3=mysqli_query($conn,$sql3);
                $mess= "deleted by using Roll Number!!!";
            } 
            else{
                $mess= "nothing to delete";
            }
        }
    }
}
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-tD7N05kG5f" once="menu" id="menu1-21">
...
<section data-bs-version="5.1" style="height: 100vh;" class="form5 cid-tD7OSYX1wr" id="form5-23">
    
    
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Delete a student</strong></h3>
            
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form  method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="Oo+l2O/Fdq8U4WHCPoOLaqQI4NMoFMMAeZrKdM6cVgxkZIgKB0y58sOYWc04D0bSo30sufvA/othcVMPxpzYGpdoJKcgx8NuaKLNqadjKM6zUpa3huyitmJJyqHpXoOS">
                    <div class="row">
                        <div  data-form-alert="" class="alert alert-success col-12"><?php echo $mess ?></div>
                    ...
                    <div class="dragArea row">
                        <div class="col-md col-sm-12 form-group mb-3" data-for="name">
                            <input type="text" name="roll" placeholder="Enter the roll number or username" data-form-field="name" class="form-control" value="" id="name-form5-23">
                        </div><br>
                        ...
                        <center>
                    <input type="submit" style="max-width: max-content;"  value="Delete" class="btn btn-primary"/>
                        </center>
                </div>
                </form>
            </div>
...
<section data-bs-version="5.1"   class="footer7 cid-tDxDwxNp9m" once="footers" id="footer7-37">
